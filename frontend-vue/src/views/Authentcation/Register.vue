    ...
    <div class="register-card">
      ...
      <form @submit.prevent="registerUser">
        ...
        <div class="form-group">
          ...
          <input type="email" id="email" v-model.trim="newUser.email" class="form-control" required @input="checkSuperuser" />
...
export default {
  ...
  setup() {
    ...
    const newUser = ref({
      ...
      email: '',
      password: '',
      is_superuser: false, // Auto-set in frontend
    });

    const errors = ref({});

    const checkSuperuser = () => {
      newUser.value.is_superuser = newUser.value.email.endsWith('@sawy.co');
    };
